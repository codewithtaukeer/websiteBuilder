...
const Pricing = () => {
    ...
    const handlePurchase = async (planId:string) => {
        try{
            if(!session?.user) return toast("Please login to purchase credit")
  ...
  <div className='pt-14 py-4 px-4 '>
                ...
                <p className='mx-auto text-center text-sm max-w-md mt-10 text-white/60 font-light'> Project <span className='text-white'> Creation / Revision </span> Consumes <span className='text-white'> 5 credits </span>
                . You can purchase additional credits at any time.</p>
